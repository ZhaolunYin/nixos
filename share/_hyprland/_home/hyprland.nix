{ pkgs, ... }:
{
    ...
    wayland.windowManager.hyprland = {
        ...
        extraConfig = ''
            ...
            hl.bind(main_mod  .. " + M",     hl.dsp.exec_cmd("pkill -USR1 hyprlock 2>/dev/null; hyprshutdown; hyprctl dispatch 'hl.dsp.exit()'"), { long_press = true })
            ...
            hl.bind(shift_mod .. " + S",     hl.dsp.exec_cmd("noctalia msg screenshot-region"))
            hl.bind(main_mod  .. " + W",     hl.dsp.exec_cmd("noctalia msg panel-toggle wallpaper"))
            hl.bind(main_mod  .. " + I",     hl.dsp.exec_cmd("noctalia msg panel-toggle control-center"))
            hl.bind(shift_mod  .. " + V",     hl.dsp.exec_cmd("noctalia msg panel-toggle clipboard"))
            hl.bind(main_mod  .. " + N",     hl.dsp.exec_cmd("rm -r ~/.local/state/noctalia/"))
